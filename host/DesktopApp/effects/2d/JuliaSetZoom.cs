...
namespace Leds.effects._2d
{
    ...
    /// </summary>
    internal class JuliaSetZoom : RaytracedEffect
    {
        ...
        private int _framesSinceLastSearch;
        private double _targetX;
        private double _targetY;

        // Julia set parameters (can animate these for different fractals)
        private double _cReal;
        private double _cImag;

        public JuliaSetZoom(LedLine attachedLedLine) : base(attachedLedLine, samplesPerPixel: 4)
        {
            _zoom = 1.0;
            _offsetX = 0.0;
            _offsetY = 0.0;
            ...
            // Classic Julia set parameters (these create interesting patterns)
            _cReal = -0.7;
            _cImag = 0.27015;
        }
        ...
        {
            return 30; // 30 FPS for smooth animation
        }
    }
}
